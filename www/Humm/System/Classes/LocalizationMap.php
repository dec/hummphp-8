...
class LocalizationMap extends Unclonable {
   ...
   */
  public const MONTHS_ABBR = 'monthsAbbr';

  /**
   * Define the meridiams key for use in the locale information map.
   */
  public const MERIDIAMS = 'meridiams';

  /**
   * Define the default (english) "am" lower meridiem.
   */
  private const MERIDIEM_AM_LOWER = 'am';

  /**
   * Define the default (english) "AM" upper meridiem.
   */
  private const MERIDIEM_AM_UPPER = 'AM';

  /**
   * Define the default (english) "pm" lower meridiem.
   */
  private const MERIDIEM_PM_LOWER = 'pm';

  /**
   * Define the default (english) "PM" lower meridiem.
   */
  private const MERIDIEM_PM_UPPER = 'PM';
   ...
   * @static
   */
  private static function setMeridiams () : void {
   ...
   * @static
   */
  private static function setDays () : void {
   ...
   * @static
   */
  private static function setDayAbbrevs () : void{
   ...
   * @static
   */
  private static function setDayInitials () : void {
    ...
    foreach ($m[self::DAYS_INIT] as $day => $initial) {
      ...
      $m[self::DAYS_INIT][$day] = \preg_replace('/_.+_initial$/', StrUtils::EMPTY_STRING, $initial);
    }
   ...
   * @static
   */
  private static function setMonths () : void {
   ...
   * @static
   */
  private static function setMonthAbbrevs () : void {
